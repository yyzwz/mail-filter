<template>
  <div>
    <Drawer title="导入卖家数据" closable v-model="visible" draggable width="1000">
      <car>
        <Row>
        ...
        <span style="font-size:30px;color:#f00">请双击车主完成导入！</span><br>
...
export default {
  ...
  methods: {
    ...
    getHuaUserList() {
      ...
      getCarOwnerList(this.huasearchForm).then(res => { // getHuaListData
