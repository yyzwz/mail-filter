            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="title">
                        <Input type="text" v-model="searchForm.title" placeholder="邮件标题" clearable style="width: 200px" />
                    </Form-item>
                    <Form-item label="" prop="toUser">
                        <Input type="text" v-model="searchForm.formUser" placeholder="发件人" clearable style="width: 200px" />
                    </Form-item>
                    <Form-item label="" prop="content">
                        <Input type="text" v-model="searchForm.content" placeholder="邮件内容" clearable style="width: 200px" />
                    </Form-item>
...
export default {
                        ...
                        return h("div", [
                            ...
                            h(
                                "Button", {
                                    ...
                                    on: {
                                        click: () => {
                                            this.deleteOnUserFx(params.row);
                                        }
                                    }
                                },
                                "移至回收站"
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getMailArchivesList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
