            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="title">
                        <Input type="text" v-model="searchForm.title" placeholder="请输入邮件标题" clearable style="width: 200px" />
                    </Form-item>
                    <Form-item label="" prop="toUser">
                        <Select v-model="searchForm.toUser" placeholder="请选择" clearable style="width: 200px">
                            <Option value="0">下拉框值A</Option>
                            <Option value="0">下拉框值B</Option>
                        </Select>
                    </Form-item>
                    <Form-item label="" prop="content">
                        <Input type="text" v-model="searchForm.content" placeholder="请输入邮件内容" clearable style="width: 200px" />
                    </Form-item>
