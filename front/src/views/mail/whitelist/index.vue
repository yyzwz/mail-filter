            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="title">
                        <Input type="text" v-model="searchForm.title" placeholder="请输入白名单规则名称" clearable style="width: 200px" />
                    </Form-item>
                    <Form-item label="" prop="mailAddress">
                        <Input type="text" v-model="searchForm.mailAddress" placeholder="请输入放行邮箱" clearable style="width: 200px" />
                    </Form-item>
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getWhitelistList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
