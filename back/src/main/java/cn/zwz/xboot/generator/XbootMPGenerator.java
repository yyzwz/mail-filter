package cn.zwz.xboot.generator;

import cn.zwz.xboot.generator.bean.Entity;
import cn.zwz.xboot.generator.bean.Item;
...
import static cn.zwz.xboot.generator.XbootGenerator.*;
...
public class XbootMPGenerator {
     ...
     * 建议仅需修改
     */
    private static final String className = "CarOwner";

    /**
     * 类说明描述
     * 建议仅需修改
     */
    private static final String description = "买家信息";
     ...
     * (文件自动生成至该包下)
     */
    private static final String entityPackage = "cn.zwz.xboot.modules.tricycle.entity";

    /**
     * dao对应包 【注意修改后需到cn.zwz.xboot.config.mybatisplus.MybatisPlusConfig配置你的mapper路径扫描】
     * (文件自动生成至该包下)
     */
    private static final String daoPackage = "cn.zwz.xboot.modules.tricycle.mapper";

    /**
     * service对应包
     * (文件自动生成至该包下)
     */
    private static final String servicePackage = "cn.zwz.xboot.modules.tricycle.service";

    /**
     * serviceImpl对应包
     * (文件自动生成至该包下)
     */
    private static final String serviceImplPackage = "cn.zwz.xboot.modules.tricycle.serviceimpl";

    /**
     * controller对应包
     * (文件自动生成至该包下)
     */
    private static final String controllerPackage = "cn.zwz.xboot.modules.tricycle.controller";
